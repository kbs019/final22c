...
public class RefundService {
    ...
    public Long requestRefund(long orderId,
        ...
        if (refundRepository.existsByOrderAndStatus(order, STATUS_PENDING)) {
        ...
        for (Map<String, Object> m : items) {
            ...
            rd.setRefundQty(qty);
            rd.setUnitRefundAmount(unit);
            rd.setDetailRefundAmount(line);
        ...
        refund.setTotalRefundAmount(totalRefund);
